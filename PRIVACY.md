...
If you change the language, the app remembers that choice in your own browser's local storage, under the name `finance-calculator-language`, so the calculator opens in the same language next time. It stores nothing else there. You can remove it at any time by clearing your browser's site data.
...
## Moderators creating a calculator post
